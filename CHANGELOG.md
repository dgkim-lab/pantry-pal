...
- Added a persisted “Automatically add after scanning” camera toggle. Added master items now include `defaultQuantity` and `currency` attributes, with green/red notifications indicating whether Open Food Facts found the product.
